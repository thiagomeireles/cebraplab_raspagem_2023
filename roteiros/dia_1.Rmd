...
3- A primeira experiência de raspagem de dados no curso será com o [Tutorial 1](): Páginas com tabelas. Neste tutorial, veremos rapidamente como extrair dados que estão em *tabelas* nos sites e alguns aspectos imporantes para o curso. A versão *Rmd* está disponível [aqui]().

4- A seguir, faça os tutoriais, na sequência: 

- [Tutorial 2](): Realizar a extração de qualquer conteúdo de uma página utilizando os "caminhos" dos elementos da página no código html. Aqui para  versão [Rmd]();
