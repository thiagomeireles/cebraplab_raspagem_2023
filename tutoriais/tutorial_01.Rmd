...
Para acessar o conteúdo de uma página, precisamos de funções que façam algo semelhante a um navegador de internet, ou seja, que se comuniquem com o servidor da página e receba o seu conteúdo. Para capturar uma página, ou melhor, o código HTMBoa nL no qual a página está escrita, utilizamos a função *read_html*, do pacote *rvest*. Vamos usar um exemplo com a Wikipedia.
